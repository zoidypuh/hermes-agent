...
- Upstream base: `136f8dab6709ac1a9caf8aade60446dd8cbab7a9`
- Code tip before this handoff-only commit: `4d87af006bdd889f6466d3798b0075b49ff75ef2`
...
- Latest official `upstream/main`: `136f8dab6709ac1a9caf8aade60446dd8cbab7a9`
- Clean local `main`: `136f8dab6709ac1a9caf8aade60446dd8cbab7a9`
- Published fork `origin/main`: `136f8dab6709ac1a9caf8aade60446dd8cbab7a9`
- Previous local/fork `main`: `bb7ff7dc302cbcbe41cf6bc09424ffc9fb2d062f`

Fork `main` moved from `bb7ff7dc3` to `136f8dab6` by a normal
fast-forward. No force push was used anywhere.
...
1. `c7b959ce5545fff5911756c4875704bc3704667b` — narrow the
   deception-hide verification false positive while retaining concealment
   detection.
2. `d5dc935d2c7546c9d5952eb70a4e6738f330eed1` — bound generic recalled
   memory, remove provider headings, and label it as stale/non-user-authored.
3. `4d87af006bdd889f6466d3798b0075b49ff75ef2` — make one-shot requests
...
- `feature/hindsight-summary-retention-20260726`
  - Tip: `4d761954f2b968fb8f94ed72fe9d80ce93960223`
...
- `feature/mem0-safe-local-runtime-20260726`
  - Tip: `a45d2103873a909cd2a1d0ff897317d517293d8c`
...
|---|---|---|
| `2e251a583` | Already upstreamed | Per-request agent options are covered by upstream `d66a82000c8b3729a01c9d0b92d424c3c2aa3733`; the useful one-shot caller fix is the smaller aggregate commit `4d87af006`. |
...
| `71cf1a163` | Coherent feature | Local Mem0 endpoint intent was ported onto current upstream in `a45d2103873a909cd2a1d0ff897317d517293d8c`. |
...
| `21cbae39c` | Mixed/coherent feature | Mixed gateway/Hindsight runtime patch. Hindsight summary behavior was isolated cleanly in `4d761954f`; unrelated legacy pieces were dropped. |
...
- `hermes --version` reports:
  - upstream `136f8dab`
  - local code tip `4d87af00`
  - three carried commits
- Verified imports:
  - `run_agent`
  - `hermes_cli.main`
  - `hermes_cli.oneshot`
