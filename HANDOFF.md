...
- Upstream base: `a75ec9278cac87445d2fc8a9477d6f66a78c7b2e`
- Code tip before this handoff-only commit: `e4ca5e4fef7d81d19bc2db3fc4869412282a7a5c`
...
- Latest official `upstream/main`: `a75ec9278cac87445d2fc8a9477d6f66a78c7b2e`
- Clean local `main`: `a75ec9278cac87445d2fc8a9477d6f66a78c7b2e`
- Published fork `origin/main`: `a75ec9278cac87445d2fc8a9477d6f66a78c7b2e`
- Previous local/fork `main`: `bb7ff7dc302cbcbe41cf6bc09424ffc9fb2d062f`

Fork `main` moved from `bb7ff7dc3` through `136f8dab6` and `b792bd052` to
`a75ec9278` by normal fast-forwards. Upstream advanced twice during final
audits, so all three patch branches were backed up at each boundary, rebased
onto the new tip, retested, and published with explicit force-with-lease. No
blind force push was used.
...
1. `56b3a6bed190e1fa96dd60d6db50182946b3a9f6` — narrow the
   deception-hide verification false positive while retaining concealment
   detection.
2. `0c9190fee3ade4ae933065739263eb261a8894e6` — bound generic recalled
   memory, remove provider headings, and label it as stale/non-user-authored.
3. `e4ca5e4fef7d81d19bc2db3fc4869412282a7a5c` — make one-shot requests
...
- `feature/hindsight-summary-retention-20260726`
  - Tip: `e41c70f2caffa7b7d466dbcd2db8f5186590cbf8`
...
- `feature/mem0-safe-local-runtime-20260726`
  - Tip: `3210c0e376f483b5f43821904b3c1755b1d16be7`
...
|---|---|---|
| `2e251a583` | Already upstreamed | Per-request agent options are covered by upstream `d66a82000c8b3729a01c9d0b92d424c3c2aa3733`; the useful one-shot caller fix is the smaller aggregate commit `e4ca5e4fe`. |
...
| `71cf1a163` | Coherent feature | Local Mem0 endpoint intent was ported onto current upstream in `3210c0e376f483b5f43821904b3c1755b1d16be7`. |
...
| `21cbae39c` | Mixed/coherent feature | Mixed gateway/Hindsight runtime patch. Hindsight summary behavior was isolated cleanly in `e41c70f2c`; unrelated legacy pieces were dropped. |
...
- Python: `3.13.13`
- Final `hermes --version` verification reports upstream `a75ec927` and four
  carried commits. Three are the runtime patches ending at code tip
  `e4ca5e4f`; the fourth is this handoff-only documentation commit and has no
  runtime code effect.
- Verified imports:
  - `run_agent`
  - `hermes_cli.main`
