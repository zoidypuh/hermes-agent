...
- Upstream base: `40dc36a8423b9a94b1fc18e7c72bd0ef8bfb91fd`
- Code tip before this handoff-only commit: `299de11017712f574cfda529f84d509ec11b2021`
...
- Latest official `upstream/main`: `40dc36a8423b9a94b1fc18e7c72bd0ef8bfb91fd`
- Clean local `main`: `40dc36a8423b9a94b1fc18e7c72bd0ef8bfb91fd`
- Published fork `origin/main`: `40dc36a8423b9a94b1fc18e7c72bd0ef8bfb91fd`
- Previous local/fork `main`: `bb7ff7dc302cbcbe41cf6bc09424ffc9fb2d062f`

Fork `main` moved from `bb7ff7dc3` through `136f8dab6`, `b792bd052`, and
`a75ec9278` to `40dc36a84`. A later fork-only formatting-bot commit
`a66e89770` had diverged from official upstream; it was preserved on safety
and archive refs before fork `main` was deliberately realigned. All patch
branches were backed up at every boundary, rebased onto the new official tip,
retested, and published with explicit force-with-lease. No blind force push
was used.
...
1. `d7c74effcf42554de65607683da4d337b6e8f3a5` — narrow the
   deception-hide verification false positive while retaining concealment
   detection.
2. `1db520decf5e0fd9b8c841be010bcb4f0d99be32` — bound generic recalled
   memory, remove provider headings, and label it as stale/non-user-authored.
3. `299de11017712f574cfda529f84d509ec11b2021` — make one-shot requests
...
- `feature/hindsight-summary-retention-20260726`
  - Tip: `c802ed12055eef2b3e01f1f1fd2dc217f44eb5b2`
...
- `feature/mem0-safe-local-runtime-20260726`
  - Tip: `bd6837ba4b2d7cc2990e48620ce35e82105d48dc`
...
Upstream advanced once more during the parity check. A second set was pushed
under `safety/20260727T001719Z/`:

| Ref suffix | SHA |
|---|---|
| `aggregate-pre-final-sync` | `8111f9092b2dca7205df8ffa956b8bedf3b44659` |
| `hindsight-pre-final-sync` | `97f0c1153df3a53c44fc667bcca62ef0380704d2` |
| `mem0-pre-final-sync` | `ccf1cfaac196fdfe1dc1761fef30353223877df7` |
| `main-pre-final-sync` | `b792bd0529ca21bde168b17e9a00ca8dad992b90` |

The later refresh was preserved under `safety/20260727T004253Z/`:

| Ref suffix | SHA |
|---|---|
| `aggregate-pre-refresh` | `c8c84bfe15e70a977e39d66dfb52d67af82de132` |
| `hindsight-pre-refresh` | `e41c70f2caffa7b7d466dbcd2db8f5186590cbf8` |
| `mem0-pre-refresh` | `3210c0e376f483b5f43821904b3c1755b1d16be7` |
| `main-pre-refresh` | `a75ec9278cac87445d2fc8a9477d6f66a78c7b2e` |
| `fork-main-pre-refresh` | `a66e89770f450b833830a75b393b204ae180a9c6` |

### Pushed archive refs

| Full archive ref | SHA | Purpose |
|---|---|---|
| `archive/20260726/current-staged-wip` | `f5302a7798f694ba17e45b7106875b1134cc9778` | Full original staged/untracked WIP |
| `archive/20260726/historical-fork-aggregate` | `24b13f2b98b5464434ed9a63c3065c4ce19c9b11` | Latest mixed historical fork stack |
| `archive/20260726/historical-runtime-stack` | `6ca1cb97c2e9e3036defff0e2ab88eb82f9c0f1b` | Proxy/vision/runtime stack |
| `archive/20260726/historical-voice-stack` | `6f755e69eb3a68fbc78d4cc0e16f1156de2585f2` | Voice relay/TTS/STT stack |
| `archive/20260726/historical-external-voice-ingress` | `00546684171bb426d778fcc3a682c896a48a1896` | External transcript ingress |
| `archive/20260726/historical-honcho-stack` | `e9e439af6afe3aa58627cbc8485e718e290a892d` | Honcho filtering/audit stack |
| `archive/20260726/historical-mem0-stack` | `ddb3d56e9b6fb10ad03222084f9863a1eea54388` | Historical Mem0 stack |
| `archive/20260726/historical-codebase-course` | `5f342839b151321bb23e67be30a0b666ddedc954` | Generated course/minimal-prompt stack |
| `archive/20260726/tool-approval-wip` | `7216c744bc733c3a60a77a00e7673a845950a7a4` | Old approval-hook WIP |
| `archive/20260726/lcm-preflight-pre-upstream` | `00a33a5c887576b83d8229005d33ba35ca0eb9d7` | Pre-upstream LCM implementation |
| `archive/20260727/fork-main-format-bot` | `a66e89770f450b833830a75b393b204ae180a9c6` | Post-sync fork-only formatting-bot commit preserved before main realignment |
...
|---|---|---|
| `2e251a583` | Already upstreamed | Per-request agent options are covered by upstream `d66a82000c8b3729a01c9d0b92d424c3c2aa3733`; the useful one-shot caller fix is the smaller aggregate commit `299de1101`. |
...
| `71cf1a163` | Coherent feature | Local Mem0 endpoint intent was ported onto current upstream in `bd6837ba4b2d7cc2990e48620ce35e82105d48dc`. |
...
After the original audit, fork automation added `a66e89770` (`fmt(js): npm
run fix on merge (#2)`) on the older upstream base. It touched two desktop
undo-history files, diverged from official upstream, and was not part of the
approved runtime patch set. It is classified as post-sync fork-only/obsolete
and remains recoverable from both
`safety/20260727T004253Z/fork-main-pre-refresh` and
`archive/20260727/fork-main-format-bot`.
...
- One aggregate run hit a CPython 3.13 segmentation fault during pytest
  collection before any test executed; the wrapper retry passed. The affected
  79-test cron file then passed three additional independent runs.
...
- Python: `3.13.13`
- Final `hermes --version` verification reports upstream `40dc36a8` and four
  carried commits. Three are the runtime patches ending at code tip
  `299de110`; the fourth is this handoff-only documentation commit and has no
  runtime code effect.
- Verified imports:
  - `run_agent`
  - `hermes_cli.main`
