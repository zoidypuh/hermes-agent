...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("fuel", "Show remaining Claude + Codex subscription quota (5h/7d)", "Info",
               aliases=("f",)),
    CommandDef("proxy-usage", "Show Hermes token usage through the local CLI proxy", "Info",
               aliases=("pu",)),
